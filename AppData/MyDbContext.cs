...
namespace AppData
{
	public class MyDbContext : DbContext
	{
		...
		{
			optionsBuilder.UseSqlServer("Data Source=THANHCONGTU\\SQLEXPRESS01;Initial Catalog=SneakerT7M1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
		}
