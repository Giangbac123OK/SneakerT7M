...
namespace AppData
{
	public class MyDbContext : DbContext
	{
		...
		{
			optionsBuilder.UseSqlServer("Data Source=HOANGTHANHGIANG\\SQLEXPRESS;Initial Catalog=SneakerT7M1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
		}
