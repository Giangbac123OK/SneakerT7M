...
{
	public class KhachHang_SaleService:KhachHang_ISaleService
	{
		private readonly KhachHang_IsaleRepos _repository;
        public KhachHang_SaleService(KhachHang_IsaleRepos repository)
        {
