...
namespace AppData.Service
{
    ...
    {
        private readonly ILichsuthanhtoanRepos _repository;
        private readonly IphuongthucthanhtoanRepos _PTTTrepository;
        private readonly IHoadonRepository _HDrepository;
        public LichsuthanhtoanService(ILichsuthanhtoanRepos repository, IphuongthucthanhtoanRepos PTTTrepository, IHoadonRepository HDrepository)
        {
