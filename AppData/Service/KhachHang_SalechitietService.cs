...
{
	public class KhachHang_SalechitietService : KhachHang_ISalechitietService
	{
        private readonly KhachHang_IsalechitietRepos _repository;
        private readonly KhachHang_ISanphamchitietRepos _SPCTrepository;
        private readonly KhachHang_IsaleRepos _Salerepository;
        public KhachHang_SalechitietService(KhachHang_IsalechitietRepos repository, KhachHang_ISanphamchitietRepos SPCTrepository, KhachHang_IsaleRepos Salerepository)
        {
