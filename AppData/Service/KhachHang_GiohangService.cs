...
{
    public class KhachHang_GiohangService : KhachHang_IGiohangService
    {
        private readonly KhachHang_IGiohangRepos _repos;
        private readonly KhachHang_IKhachhangRepos _KHrepos;
        public KhachHang_GiohangService(KhachHang_IGiohangRepos repos, KhachHang_IKhachhangRepos kHrepos)
        {
            _repos = repos;
            _KHrepos = kHrepos;
        }
