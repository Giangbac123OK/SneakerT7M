...
namespace AppData.Service
{
    ...
    {
        private readonly IHinhanhRepos _repository;
        private readonly ITraHangRepos _THrepository;
        public HinhanhService(IHinhanhRepos repository, ITraHangRepos THrepository)
        {
