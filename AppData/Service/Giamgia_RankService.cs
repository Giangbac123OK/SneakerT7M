...
namespace AppData.Service
{
    ...
    {
        private readonly IGiamgia_RankRepos _repository;
        private readonly IRankRepos _Rankrepository;
        private readonly IGiamgiaRepos _GGrepository;
        public Giamgia_RankService(IGiamgia_RankRepos repository, IRankRepos Rankrepository, IGiamgiaRepos GGrepository)
        {
