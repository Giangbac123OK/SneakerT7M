...
{
    public class KhachHang_KhachhangService : KhachHang_IKhachhangService
    {
        private readonly KhachHang_IKhachhangRepos _repos;
		private readonly IConfiguration _configuration;
        private readonly KhachHang_IGiohangRepos _GHrepos;
        public KhachHang_KhachhangService(KhachHang_IKhachhangRepos repos, IConfiguration configuration, KhachHang_IGiohangRepos gHrepos)
        {
		...
		async Task<(bool isSent, object otp)> KhachHang_IKhachhangService.SendOtpAsync(string email)
		{
			try
			{
				// Kiểm tra cấu hình
