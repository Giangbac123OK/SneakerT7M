...
{
    public class KhachHang_GiohangchitietService : KhachHang_IGiohangchitietService
    {
        private readonly KhachHang_IGiohangchitietRepos _repos;
        public KhachHang_GiohangchitietService(KhachHang_IGiohangchitietRepos repos)
        {
            _repos = repos;
        }
